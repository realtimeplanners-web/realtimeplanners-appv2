...
export default function Page() {
  ...
  const [orgSortField, setOrgSortField] = useState<"name" | "created_at">(
    "created_at",
  );
      ...
      <div className="flex min-h-screen font-sans antialiased">
        ...
        >
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {sidebarOpen && (
              <div className="flex items-center gap-3">
                ...
                <h2 className="font-bold text-lg bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-500 bg-clip-text text-transparent">
                  RealTimePlanners
                </h2>
              </div>
            )}
          ...
          <div className="flex-1 space-y-2">
            ...
            >
              <div
                className={`w-5 h-5 flex items-center justify-center ${activeTab === "dashboard" ? "text-emerald-400" : "text-gray-400"}`}
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
            ...
            >
              <div
                className={`w-5 h-5 flex items-center justify-center ${activeTab === "organizations" ? "text-blue-400" : "text-gray-400"}`}
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
            ...
            >
              <div
                className={`w-5 h-5 flex items-center justify-center ${activeTab === "projects" ? "text-purple-400" : "text-gray-400"}`}
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-600 dark:text-gray-400 uppercase tracking-wide">
                    RealTimePlanners Project Management System
                  </p>
                </div>
              </div>
                ...
                <div className="bg-white/90 dark:bg-black/90 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden border border-white/20 dark:border-black/20">
                  <div className="p-6 border-b border-white/20 dark:border-black/20 bg-gradient-to-r from-emerald-500/10 via-cyan-500/10 to-blue-500/10 dark:from-emerald-500/20 dark:via-cyan-500/20 dark:to-blue-500/20">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h2 className="text-xl font-bold bg-gradient-to-r from-emerald-600 via-cyan-600 to-blue-600 dark:from-emerald-400 dark:via-cyan-400 dark:to-blue-400 bg-clip-text text-transparent">
                        ORGANIZATIONS
                      </h2>
                    </div>
                  </div>
                ...
                <div className="bg-white/90 dark:bg-black/90 backdrop-blur-xl rounded-2xl shadow-2xl overflow-hidden border border-white/20 dark:border-black/20">
                  <div className="p-6 border-b border-white/20 dark:border-black/20 bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-indigo-500/10 dark:from-purple-500/20 dark:via-pink-500/20 dark:to-indigo-500/20">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <h2 className="text-xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 dark:from-purple-400 dark:via-pink-400 dark:to-indigo-400 bg-clip-text text-transparent">
                        PROJECTS
                      </h2>
                    </div>
                  </div>
                    ...
                    <div className="space-y-2">
                      {projects.length === 0 ? (
                        ...
                        projects.map((p) => (
                          <div
                            key={p.id}
                            className="flex items-center gap-3 p-3 border border-purple-200 dark:border-purple-800 rounded-xl bg-purple-50 dark:bg-purple-900/20 hover:bg-purple-100 dark:hover:bg-purple-900/30 transition-colors"
                          >
                ...
                <div className="p-6 border-b border-white/20 dark:border-black/20 bg-gradient-to-r from-emerald-500/10 via-cyan-500/10 to-blue-500/10 dark:from-emerald-500/20 dark:via-cyan-500/20 dark:to-blue-500/20 flex-shrink-0">
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h2 className="text-2xl font-bold bg-gradient-to-r from-emerald-600 via-cyan-600 to-blue-600 dark:from-emerald-400 dark:via-cyan-400 dark:to-blue-400 bg-clip-text text-transparent">
                          ORGANIZATIONS
                        </h2>
                        <p className="text-sm text-gray-600 dark:text-gray-400 uppercase tracking-wide">
                          Manage Your Organization Portfolio
                        </p>
                      </div>
                    </div>
                    <div className="flex gap-3">
                      <div className="relative">
                        ...
                        />
                        <svg
                          className="absolute left-3 top-2.5 w-5 h-5 text-emerald-500"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                ...
                <div className="p-6 border-b border-white/20 dark:border-black/20 bg-gradient-to-r from-purple-500/10 via-pink-500/10 to-indigo-500/10 dark:from-purple-500/20 dark:via-pink-500/20 dark:to-indigo-500/20 flex-shrink-0">
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h2 className="text-2xl font-bold bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-600 dark:from-purple-400 dark:via-pink-400 dark:to-indigo-400 bg-clip-text text-transparent">
                          PROJECTS
                        </h2>
                        <p className="text-sm text-gray-600 dark:text-gray-400 uppercase tracking-wide">
                    ...
                    <div className="flex gap-3">
                      <div className="relative">
                        ...
                        />
                        <svg
                          className="absolute left-3 top-2.5 w-5 h-5 text-purple-500"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
                        ...
                        <tr>
                          ...
                          >
                            <div className="flex flex-col items-center gap-3">
                              ...
                              <p className="text-sm">
                                Select an organization and create your first
                                project
                              </p>
                            </div>
                          </td>
